...
public class ItemCreator {
    ...
    public static ItemStack getDice() {
        ...
        String type = "dice";
        if (meta != null){
            meta.getPersistentDataContainer().set(Util.ItemTags.Item.getValue(), PersistentDataType.BOOLEAN, true);
            meta.getPersistentDataContainer().set(Util.ItemTags.Type.getValue(), PersistentDataType.STRING, type);
